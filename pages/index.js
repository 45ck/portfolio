    ...
    <>
      ...
      <main>
        <section className=" h-screen bg-zinc-800 ">
          <div className={`max-md:left-full max-md:-translate-x-full hover:scale-110 fixed z-[80] sm:mt-2 sm:ml-2 cursor-pointer group transition-transform w-32`}>
            <svg viewBox="0 0 495 495" enableBackground="new 0 0 495 495" className="fill-zinc-200 md:group-hover:animate-spin max-md:group-hover:translate-y-1/4 max-md:group-hover:translate-x-1/2 md:group-hover:w-full max-md:translate-x-full transition-all w-14 h-14 lg:w-24 lg:h-24">
              <g>
            ...
            <div className={`flex lg:flex-row flex-col content-center items-center justify-self-center justify-items-center`}>
              <div className={`2xl:py-10 2xl:px-32 xl:py-8 xl:px-24  sm:py-3 sm:px-8 px-1 py-1 flex flex-col lg:flex-row`}>
                <div className={`w-1/2 max-lg:w-full z-0 order-last lg:order-first  max-lg:flex lg:flex-col flex-row justify-center max-lg:mt-4 max-lg:flex-row-reverse max-lg:pb-16`}>
                  <Image onClick={() => window.open("https://github.com/45ck/Great-Plains-Transport")} src={require("../public/great-plains.webp")} className={`${styles.projectImage} relative skew-y-2  translate-x-32 max-lg:-translate-x-16 lg:scale-90 lg:hover:scale-95 hover:scale-105 transition-all cursor-pointer brightness-90 hover:brightness-105 rounded-lg shadow-2xl shadow-black lg:m-7 max-lg:mx-4 md:mt-0 lg:w-full max-w-none max-lg:w-1/2 `} />
